...
+----------------------------------+ 
        ...
        START GPASTE INSTALL

+----------------------------------+

"
# for clipboard manager applet
sudo apt install gir1.2-gpaste-2 gpaste-2 -y
echo "
...
sudo apt install -y libdvdnav-dev libdvdread-dev libv4l-0 libx11-6 libxext6 libpulse0 libomxil-bellagio0 libjack-jackd2-0 libsdl2-2.0-0 libfaad2 libglib2.0-0 libxrender1 -y
sudo apt install -y 
